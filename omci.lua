...
[53] = { me_class_name = "Physical path termination point POTS UNI",
	...
	{ attname="Transmission path", length=4, setbycreate=false },
...
[90] = { me_class_name = "PPTP Video ANI",
 ...
 [91] = { me_class_name = "Physical path termination point 802.11 UNI",
	{ attname="Administrative State", length=1, setbycreate=false },
	{ attname="Operational State", length=1, setbycreate=true },
	{ attname="dot11 supported data rates tx", length=8, setbycreate=false },
	{ attname="dot11 supported data rates rx", length=8, setbycreate=true },
	{ attname="dot11 Tx power levels", length=16, setbycreate=false },
	{ attname="ARC", length=1, setbycreate=true },
	{ attname="ARC interval", length=1, setbycreate=false }},
...
[134] = { me_class_name = "IP host config data",
	...
	{ attname="Ont identifier", length=25, setbycreate=true },
...
[138] = { me_class_name = "VoIP config data",
	{ attname="Available signalling protocols", length=1, setbycreate=true },
	{ attname="Signalling protocol used", length=6, setbycreate=true },
	{ attname="Available VoIP configuration methods", length=4, setbycreate=true },
	{ attname="VoIP configuration method used", length=1, setbycreate=true },
	{ attname="VoIP configuration address pointer", length=2, setbycreate=true },
	{ attname="VoIP configuration state", length=1, setbycreate=true },
	{ attname="Retrieve profile", length=1, setbycreate=true },
	{ attname="Profile version", length=25, setbycreate=true }},

[140] = { me_class_name = "Call control performance monitoring history data",
	{ attname="Interval end time", length=1, setbycreate=false },
	{ attname="Threshold data 1/2 id", length=2, setbycreate=true },
	{ attname="Call setup failures", length=4, setbycreate=false },
	{ attname="Call setup timer", length=4, setbycreate=false },
	{ attname="Call terminate failures", length=4, setbycreate=false },
	{ attname="Analog port releases", length=4, setbycreate=false },
	{ attname="Analog port off-hook timer", length=4, setbycreate=false }},
...
[144] = { me_class_name = "RTP performance monitoring history data",
	{ attname="Interval end time", length=1, setbycreate=false },
	{ attname="Threshold data 1/2 id", length=2, setbycreate=true },
	{ attname="RTP errors", length=4, setbycreate=false },
	{ attname="Packet loss", length=4, setbycreate=false },
	{ attname="Maximum jitter", length=4, setbycreate=false },
	{ attname="Maximum time between RTCP packets", length=4, setbycreate=false },
...
[148] = { me_class_name = "Authentication security method",
	{ attname="ValidationScheme", length=1, setbycreate=true },
	{ attname="Username1", length=25, setbycreate=true },
	{ attname="Password", length=25, setbycreate=true },
	{ attname="Realm", length=25, setbycreate=true },
	{ attname="Username2", length=25, setbycreate=true }},

[157] = { me_class_name = "Large string",
	{ attname="Number of parts", length=1, setbycreate=true },
	{ attname="Part 1", length=25, setbycreate=true },
	{ attname="Part 2", length=25, setbycreate=true },
	{ attname="Part 3", length=25, setbycreate=true },
	{ attname="Part 4", length=25, setbycreate=true },
	{ attname="Part 5", length=25, setbycreate=true },
	{ attname="Part 6", length=25, setbycreate=true },
	{ attname="Part 7", length=25, setbycreate=true },
	{ attname="Part 8", length=25, setbycreate=true },
	{ attname="Part 9", length=25, setbycreate=true },
	{ attname="Part 10", length=25, setbycreate=true },
	{ attname="Part 11", length=25, setbycreate=true },
	{ attname="Part 12", length=25, setbycreate=true },
	{ attname="Part 13", length=25, setbycreate=true },
	{ attname="Part 14", length=25, setbycreate=true },
	{ attname="Part 15", length=25, setbycreate=true }},
...
[280] = { me_class_name = "GEM traffic descriptor",
...
[306] = { me_class_name = "Dot1ag chassis-management info",
	{ attname="Max ports", length=1, setbycreate=false },
	{ attname="Chassis ID length", length=1, setbycreate=false },
	{ attname="Chassis ID subtype", length=1, setbycreate=false },
	{ attname="Chassis ID part 1", length=25, setbycreate=false },
	{ attname="Chassis ID part 2", length=25, setbycreate=false },
	{ attname="Management address domain length", length=1, setbycreate=false },
	{ attname="Management address domain 1", length=25, setbycreate=false },
	{ attname="Management address domain 2", length=25, setbycreate=false },
	{ attname="Management address length", length=1, setbycreate=false },
	{ attname="Management address 1", length=25, setbycreate=false },
	{ attname="Management address 2", length=25, setbycreate=false }},
...
[318] = { me_class_name = "File transfer controller",
	...
	{ attname="File type", length=2, setbycreate=true },
	...
	{ attname="File transfer trigger", length=1, setbycreate=true },
	...
	{ attname="Directory listing table", length=24, setbycreate=false }},
...
[336] = { me_class_name = "ONU dynamic power management control",
	...
	{ attname="Maximum receiver-off interval", length=4, setbycreate=true },
	{ attname="Minimum aware interval", length=4, setbycreate=true },
	{ attname="Minimum active held interval", length=2, setbycreate=true },
	{ attname="Maximum sleep interval extension", length=8, setbycreate=false },
	{ attname="Ethernet passive optical network (EPON) capability extension", length=1, setbycreate=false },
	{ attname="EPON setup extension", length=1, setbycreate=false },
	{ attname="Missing consecutive bursts threshold", length=4, setbycreate=true }},
...
function addAttrList(tree, content, offset, meClass, hasValue, hasMask)
	...
	if hasMask then
		...
		masktree:add(mask, tostring(Hex2Bin(tostring(mask))))
	end
